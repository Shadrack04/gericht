...
function Hero() {
  return (
    <div className=" flex flex-col md:flex-row items-center justify-center gap-10 max-w-[61.2rem] h-[46rem] pt-8 mx-auto">
      <div className=" w-full md:w-[28rem] md:h-[30rem] flex flex-col justify-center gap-4">
        ...
        <h1 className="dining text-4xl md:text-[5.6rem] text-[#DCCA87] font-bold">
